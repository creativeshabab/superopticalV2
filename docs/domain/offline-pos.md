...
| **Prescription Entry** | Optometrist records eye refraction test. | Stored locally; prints paper slip; queued for cloud backup upon reconnect. |
...
> Server timestamp precedence is strictly forbidden for financial and inventory state.

### Conflict Scenarios & Policies:
1. **Concurrent Stockout Conflict:**
